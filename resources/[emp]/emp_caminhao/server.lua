...
local paylist = {
	["diesel"] = {
		[1] = { pay = math.random(1200,1650) },
		[2] = { pay = math.random(1200,1650) },
		[3] = { pay = math.random(1200,1650) },
		[4] = { pay = math.random(1200,1650) },
		[5] = { pay = math.random(1300,1750) },
		[6] = { pay = math.random(1200,1650) }
	},
	["gas"] = {
		...
		[9] = { pay = math.random(950,1400) },
		[10] = { pay = math.random(1000,1600) },
		[11] = { pay = math.random(1000,1600) },
		[12] = { pay = math.random(900,1400) }
	},
	["cars"] = {
		[1] = { pay = math.random(700,1000) },
		[2] = { pay = math.random(700,1000) },
		[3] = { pay = math.random(700,1000) },
		[4] = { pay = math.random(700,1000) },
		[5] = { pay = math.random(1000,1800) }
	},
	["woods"] = {
		[1] = { pay = math.random(1900,2000) },
		[2] = { pay = math.random(980,1600) },
		[3] = { pay = math.random(800,1300) },
		[4] = { pay = math.random(800,1100) }
	},
	["show"] = {
