...
emP = Tunnel.getInterface("emp_entregacoca")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
...
local selecionado = 0
local porcentagem = 0
local CoordenadaX = -158.93
local CoordenadaY = -1630.40
local CoordenadaZ = 34.17
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
		...
		if not servico then
			...
			if distance <= 30.0 then
				...
				if distance <= 1.2 and not servico then
					drawTxt("PRESSIONE  ~b~E~w~  PARA ENTREGAR COCAINA",4,0.5,0.93,0.50,255,255,255,180)
