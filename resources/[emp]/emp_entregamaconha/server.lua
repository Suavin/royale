...
emP = {}
Tunnel.bindInterface("emp_entregamaconha",emP)
...
function emP.checkPermission()
	...
	return not vRP.hasPermission(user_id,"maconha.permissao")
end
...
function emP.checkPayment()
	...
	if user_id then
		if vRP.tryGetInventoryItem(user_id,"maconha",quantidade[source]) then
			...
			TriggerClientEvent("Notify",source,"aviso","Você precisa de <b>"..quantidade[source].."x Maconhas</b>.")
		end
	end
end
