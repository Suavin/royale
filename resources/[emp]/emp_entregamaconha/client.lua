...
emP = Tunnel.getInterface("emp_entregamaconha")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
...
local selecionado = 0
local porcentagem = 0
local CoordenadaX = 78.68
local CoordenadaY = -1975.03
local CoordenadaZ = 20.92
-----------------------------------------------------------------------------------------------------------------------------------------
-- RESIDENCIAS
-----------------------------------------------------------------------------------------------------------------------------------------
local locs = {
		...
		if not servico then
			...
			if distance <= 30.0 then
				...
				if distance <= 1.2 and not servico then
					drawTxt("PRESSIONE  ~b~E~w~  PARA ENTREGAR MACONHA",4,0.5,0.93,0.50,255,255,255,180)
