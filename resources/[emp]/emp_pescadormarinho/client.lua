...
emP = Tunnel.getInterface("emp_pescadormarinho")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
...
Citizen.CreateThread(function()
	while true do
		...
		if not processo then
			...
			local distancia = GetDistanceBetweenCoords(GetEntityCoords(ped),4774.65,5837.03,0.85)
			if distancia <= 180 then
				DrawMarker(1,4774.65,5837.03,0.85-1.5,0,0,0,0,0,0,350.0,350.0,50.0,255,255,255,30,0,0,0,0)
				if distancia <= 180 then
					drawTxt("PRESSIONE  ~b~E~w~  PARA INICIAR A PESCARIA MARINHA",4,0.5,0.93,0.50,255,255,255,180)
