...
RegisterNUICallback("settingtoggle", function(data, cb)
	...
	elseif(action=="mobileradio")then
		...
		drawNotification("[~p~Chicago~w~] Player Radio: "..text)
