...
function createNoClipMenuOptions()
    local options = {"Noclip Opções: F2","W = Mover para frente","S = Mover para trás","A = Rodar para esquerda","D = Rodar para direita","Q = Move para cima","Z = Move para baixo","Shift = Altera a velocidade"}
    local speeds = { "Muito lento", "Meio lento", "Lento", "Normal", "Rápido", "Meio Rápido", "Muito Rápido" }
    local menuOpts = {}
    ...
    local curSpeed = {["menuName"] = "Velocidade atual = "..(speeds[travelSpeed] or "NA")}
