TokoVoipConfig = {
	channels = {
		{name = "Policia", subscribers = {"policia.permissao"}},
		{name = "Paramedico", subscribers = {"paramedico.permissao"}},
		{name = "Mecanico", subscribers = {"mecanico.permissao"}},
		{name = "Bennys", subscribers = {"tuning.permissao"}},
		{name = "Roxos", subscribers = {"maconha.permissao"}},
