TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "Jogando",
		TSPassword = "cpp2255", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Entrada",

		-- Blocking screen informations
		TSServer = "ts.royaleroleplay.com.br:9500", -- TeamSpeak server address to be displayed on blocking screen
