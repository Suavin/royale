...
-----------------------------------------------------------------------------------------------------------------------------------------
local valores = {
	{ item = "atum", venda = 2500 },
	{ item = "espada", venda = 950 },
	{ item = "xareu", venda = 340 },
	{ item = "tubarao", venda = 2000 },
	{ item = "bicuda", venda = 250 },
	{ item = "marlim", venda = 600 },
	{ item = "tainha", venda = 400 },
	{ item = "pampo", venda = 200 },
	{ item = "nero", venda = 8000 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VENDER
-----------------------------------------------------------------------------------------------------------------------------------------
