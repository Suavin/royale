...
cfg.garage_types = {
	...
	["Vendedor"] = {
		...
		["buccaneer"] = { "buccaneer",0,0,-1 },
		["baller"] = { "baller",0,0,-1 },
		["primo2"] = { "primo2",0,0,-1 },
		["jester"] = { "jester",0,0,-1 },
		["chino2"] = { "chino2",0,0,-1 },
		["contender"] = { "contender",0,0,-1 },
		["buccaneer2"] = { "buccaneer2",0,0,-1 },
		["voodoo"] = { "voodoo",0,0,-1 },
		["sultan"] = { "sultan",0,0,-1 },
		["baller3"] = { "baller3",0,0,-1 },
		["omnis"] = { "omnis",0,0,-1 },
		["sultanrs"] = { "sultanrs",0,0,-1 },
		["elegy"] = { "elegy",0,0,-1 },
		["dubsta3"] = { "dubsta3",0,0,-1 },
		["turismo2"] = { "turismo2",0,0,-1 },
		["baller5"] = { "baller5",0,0,-1 },
		["toros"] = { "toros",0,0,-1 },
		["faggio"] = { "faggio",0,0,-1 },
		["faggio3"] = { "faggio",0,0,-1 },
		["Bike"] = { "Motorizada",0,0,-1 },
		["pcj"] = { "pcj",0,0,-1 },
		["enduro"] = { "enduro",0,0,-1 },
		["sanchez2"] = { "sanchez2",0,0,-1 },
		["avarus"] = { "avarus",0,0,-1 },
		["manchez"] = { "manchez",0,0,-1 },
		["sovereign"] = { "sovereign",0,0,-1 },
		["bati"] = { "bati",0,0,-1 },
		["bf400"] = { "bf400",0,0,-1 },
		["carbonrs"] = { "carbonrs",0,0,-1 },
		["nightblade"] = { "nightblade",0,0,-1 },
		["hakuchou"] = { "hakuchou",0,0,-1 },
		["hakuchou2"] = { "hakuchou2",0,0,-1 },
		["akuma"] = { "akuma",0,0,-1 },
		["sanctus"] = { "sanctus",0,0,-1 }
	},
	["Carros"] = {
		_config = { gtype={"store"},permissions={"conce.permissao"} },
		...
		["chino2"] = { "chino2",280000,60,30 },
		["contender"] = { "contender",320000,30,30 },
		["buccaneer2"] = { "buccaneer2",320000,60,30 },
		["voodoo"] = { "voodoo",340000,60,30 },
		["sultan"] = { "sultan",360000,30,30 },
		["baller3"] = { "baller3",420000,50,30 },
		["omnis"] = { "omnis",450000,20,30 },
		["sultanrs"] = { "sultanrs",460000,30,30 },
		["elegy"] = { "elegy",560000,30,30 },
		["dubsta3"] = { "dubsta3",720000,100,30 },
		["turismo2"] = { "turismo2",880000,30,30 },
		["baller5"] = { "baller5",960000,50,30 },
		["toros"] = { "toros",1280000,50,30 }
	},
	["Motos"] = {
		_config = { gtype={"store"},permissions={"conce.permissao"} },
		["faggio"] = { "faggio",14000,15,30 },
		["faggio3"] = { "faggio3",12000,15,30 },
		...
		["carbonrs"] = { "carbonrs",430000,15,30 },
		["nightblade"] = { "nightblade",650000,15,30 },
		["hakuchou"] = { "hakuchou",760000,15,30 },
		["hakuchou2"] = { "hakuchou2",820000,15,30 },
		["akuma"] = { "akuma",950000,15,30 },
		["sanctus"] = { "sanctus",1350000,15,10 }
	},
	["Veiculos"] = {
		_config = { gtype={"store"} },
		["faggio"] = { "faggio",14000,15,30 },
	...
	["Bennys"] = {
		_config = { gtype={"shop"},permissions={"tuning.permissao"} },
		_shop = {
			[11] = { "Motor",0,"" },
			[12] = { "Freios",0,"" },
			[13] = { "Transmissao",0,"" },
...
cfg.garages = {
	{ "Estetica",-327.22,-144.47,39.05,false,0 },
	{ "Estetica",-323.03,-132.89,38.96,false,0 },
	{ "Estetica",103.61,6622.61,31.82,false,0 },
	{ "Bennys",-222.66,-1324.79,30.89,false,0 },
	{ "Veiculos",-57.29,-1096.98,26.42,false,0 },
	...
	{ "CartelAereo",1726.31,3294.51,41.22,false,86 },
	...
	{ "Garagem7",1758.48,3329.61,41.39,true,79 },
	...
	{ "PescadorMarinho",3857.97,4459.41,1.82,false,85 },
