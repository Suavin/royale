...
local burglaryPlaces = {
    ...
    ["Casa 2"] = {
        pos = { x = 1399.62, y = -604.08, z = 74.48, h = 89.98 },
        locked = true,
        inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 }, 
        animPos = { x = 1399.18, y = -604.19, z = 74.48, h = 54.83 },
    },
    ["Casa 3"] = {
        pos = { x = 1367.02, y = -623.81, z = 74.71, h = 89.98 },
        locked = true,
        inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 }, 
        animPos = { x = 1366.70, y = -623.54, z = 74.71, h = 4.4 },
    },
    ["Casa 4"] = {
        pos = { x = -1151.09, y = -1519.30, z = 4.35, h = 89.98 },
        locked = true,
        inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 }, 
        animPos = { x = -1151.09, y = -1519.30, z = 4.35, h = 313.99 },
    },
    ["Casa 5"] = {
        pos = { x = -1149.87, y = -1521.96, z = 10.62, h = 89.98 },
        locked = true,
        inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 }, 
        animPos = { x = -1149.87, y = -1521.96, z = 10.62, h = 35.04 },
    },
    ["Casa 6"] = {
        pos = { x = 967.13, y = -451.65, z = 62.78, h = 89.98 },
        locked = true,
        inside = { x = 346.52 , y = -1013.19 , z = -99.2, h = 357.81 }, 
        animPos = { x = 967.13, y = -451.65, z = 62.78, h = 19.06 },
    }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOCAIS ITENS
