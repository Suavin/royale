			...
			menu["Investir"] = { function(player,choice)
				...
				if amount > 0 then
					if vRP.tryPayment(user_id,amount) then
						vRP.execute("vRP/add_capital",{ user_id = user_id, capital = amount*0.9 })
						TriggerClientEvent("Notify",player,"sucesso","Investiu <b>$"..vRP.format(amount).." dólares</b> e adicionou <b>$"..vRP.format(parseInt(amount*0.9)).."</b> ao capital.")
					else
